...
async def get_steam_game(app_id: int) -> Optional[dict]:
    # added &cc=au to force australian pricing consistency
    url = f"https://store.steampowered.com/api/appdetails?appids={app_id}&cc=au"
...
async def search_steam_game(game_name: str) -> int | None:
